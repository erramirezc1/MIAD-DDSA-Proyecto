...
with mlflow.start_run(experiment_id=experiment.experiment_id, run_name="DecisionTreeRegressor_maxDepth10"):
    modelo_dt = DecisionTreeRegressor(max_depth=10, random_state=42)  # Ajusta max_depth según sea necesario
