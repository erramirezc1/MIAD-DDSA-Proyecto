...
if command -v ufw &> /dev/null; then
    ...
    sudo ufw allow 8050/tcp comment "Dash App Importaciones"
    echo "Puertos 8001 (API) y 8050 (Dash) abiertos en firewall"
...
echo ""
echo "La aplicación Dash debería estar disponible en:"
echo "  http://$(curl -s ifconfig.me):8050"
echo ""
echo "Documentación interactiva:"
echo "  http://$(curl -s ifconfig.me):8001/docs"
echo ""
echo "Recuerda configurar el Security Group de EC2 para permitir tráfico en los puertos 8001 (API) y 8050 (Dash)"
echo ""
...
echo ""
echo "Para iniciar la aplicación Dash, ejecuta:"
echo "  source venv/bin/activate"
echo "  python app_dash.py"
echo ""
echo "O en segundo plano:"
echo "  source venv/bin/activate"
echo "  nohup python app_dash.py > dash.log 2>&1 &"
echo ""
echo "NOTA: El entorno virtual se creó en ./venv"
echo "      Siempre activa el entorno virtual antes de ejecutar la API o Dash"
echo ""
